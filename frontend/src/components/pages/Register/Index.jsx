                    ...
                    >
                        ...
                        <Form>
                          ...
                          <div className="flex items-center justify-between pb-6">
                            ...
                            <Link
                              to="/login"
                              className="inline-block rounded px-6 py-2.5 text-xs font-medium uppercase leading-normal text-cyan-500 transition duration-150 ease-in-out hover:text-cyan-600 focus:text-cyan-600 focus:outline-none focus:ring-0 active:text-cyan-600"
                            >
                              Log in
                            </Link>
                          </div>
